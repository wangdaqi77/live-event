...
open class LiveEvent<T> : LiveData<T> {
     ...
     */
    @MainThread
    protected open fun observeNoSticky(owner: LifecycleOwner, observer:Observer<in T>) {
        ...
        if (owner.lifecycle.currentState.isAtLeast(Lifecycle.State.STARTED)) {
            ...
            observeInner(owner, noStickyObserver)
            @Suppress("UNCHECKED_CAST")
            val value = mObservers.putIfAbsent(noStickyObserver, null) as LiveData<T>.LifecycleBoundObserver
     ...
     */
    @MainThread
    protected open fun observeNoLoss(owner: LifecycleOwner, observer: Observer<in T>) {
     ...
     */
    @MainThread
    protected open fun observeNoStickyNoLoss(owner: LifecycleOwner, observer: Observer<in T>) {
